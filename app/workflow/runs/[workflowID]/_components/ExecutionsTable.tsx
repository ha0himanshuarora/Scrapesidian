...
function ExecutionsTable({workflowId,initialData}:{workflowId:string,initialData:InitialDataType}) {
    ...
    const query=useQuery({queryKey:["executions",workflowId],initialData,
                            ...
                            <TableCell>
                                <div className='flex flex-col'>
                                    <div className='flex gap-2 items-center '>
                                        ...
                                        <span className="font-senibold capitalize">{execution.status}</span>
                                    </div>
                            ...
                            <TableCell>
                                <div className='flex flex-col'>
                                    <div className='flex gap-2 items-center '>
                                        ...
                                        <span className="font-senibold capitalize">{execution.creditsConsumed}</span>
                                    </div>
