...
interface Props{open:boolean;setOpen:(open:boolean)=>void;workflowName:string;workflowId:string}
...
function DeleteWorkflowDialog({open,setOpen,workflowName,workflowId}:Props) {
    ...
    const deleteMutation=useMutation({
        ...
        onSuccess:()=>{toast.success("Workflow deleted successfully",{id:workflowId});setConfirmText("");},
            ...
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    ...
                    <div className="flex flex-col py-4 gap-2">
                        <p>If Sure, Enter <b>{workflowName}</b> to confirm:</p>
