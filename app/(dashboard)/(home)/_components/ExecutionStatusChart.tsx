        ...
        <CardContent>
            <ChartContainer config={chartConfig} className='max-h-[200px] w-full'>
                <AreaChart data={data} height={200} accessibilityLayer margin={{top:20}}>
                    ...
                    <Area min={0} type={"bump"} fill='var(--color-success)' stroke='var(--color-success)' fillOpacity={0.6} dataKey={"success"} stackId={"a"}/>
                    <Area min={0} type={"bump"} fill='var(--color-failed)' stroke='var(--color-failed)' fillOpacity={0.6} dataKey={"failed"} stackId={"a"}/>
